...
const Navbar = () => {
  return (
    <div className='w-full bg-[#222836] h-full flex flex-col items-center'>
        <div className='w-10/12 bg-[#222836] max-sm:w-11/12'>
            <div className='w-full bg-[#222836] h-[70px] flex flex-row items-center justify-between'>
                ...
                <div className='hidden md:block'>
                    <ul className='flex flex-row items-center space-x-8'>
                        ...
                        <Link to={'/#pricing'}>
                            <li className='text-xs text-white md:text-sm'>Pricing</li>   
                        </Link>
                        <Link to={'/#testmonials'}>
                            <li className='text-xs text-white md:text-sm'>Testmonials</li>   
                        </Link>
                        <Link to={'/signing'}>
                            <li className='text-xs text-white md:text-sm'>Signin</li>   
                        </Link>
                        <Link to={'/signup'}>
