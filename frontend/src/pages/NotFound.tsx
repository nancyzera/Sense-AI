...
export default function NotFound() {
  return (
    <>
      <Navbar />
      <div className="w-full h-full bg-[#1a1f2e] flex flex-col mt-[40px] items-center justify-center select-none">
          ...
          <div className="w-full min-h-[50vh] flex flex-col items-center justify-center my-8">
            <div className="w-auto flex flex-col justify-center h-auto">
              ...
              <div className="flex flex-col items-center">
                <h1 className="text-black text-center text-white font-sans text-[3em]">
                  Page Doesn&apos;t Exit
                </h1>
              </div>
              <p className="text-center text-white/70 leading-6 w-full mb-6 text-[.9em]">
                Page Not Available or Was Moved.
              </p>
              <div className="w-auto flex items-center mt-4 justify-center">
                <Link to={"/"}>
                  <button className="bg-[#405cb9]/[70%] cursor-pointer mt-[30px] dark:bg-button-shadow-dark border-[1.5px] relative top-[2px] rounded-[8px] w-auto text-primary inline-block border-[#405cb9]/[20%] text-center group disabled:opacity-50 disabled:cursor-not-allowed group">
